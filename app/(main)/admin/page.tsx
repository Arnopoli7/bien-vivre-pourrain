...
const roleBadgeColors: Record<string, string> = {
  ...
  redacteur:  "bg-purple-100 text-purple-700",
...
export default function AdminPage() {
  ...
  // Seul Arnaud Poli peut accéder à cette page (après tous les hooks)
  ...
  const peutModifierAcces = currentUser?.identifiant === "ArnaudP"
