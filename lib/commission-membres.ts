export const MEMBRES_COMMISSIONS: Record<string, string[]> = {
  ...
  "Bâtiments Gros travaux": ["Pierre Maison", "Pascal Bellanger", "Anne Virtel", "Claire Vandaele", "Mélanie Darcel", "Adélina Gallet", "François Petit", "Awa Kouyate", "Frédéric Gasset", "Denis Boivin", "Quentin Bellanger"],
  ...
  "C.C.A.S.": ["Anne Virtel", "Claire Vandaele", "Adélina Gallet", "Awa Kouyate"],
  ...
  "Vie associative": ["Anne Virtel", "Claire Vandaele", "Adélina Gallet", "Gilles Laburthe", "Frédéric Gasset", "Awa Kouyate", "Maryline Ventura"],
  "Enfance Jeunesse Écoles": ["Anne Virtel", "Arnaud Poli", "Mélanie Darcel", "Frédéric Gasset", "Quentin Bellanger", "Maryline Ventura"],
  "Solidarité Entraide": ["Anne Virtel", "Arnaud Poli", "Adélina Gallet", "Awa Kouyate", "Maryline Ventura"],
  "Cadre de vie et économie": ["Pierre Maison", "Arnaud Poli", "Claire Vandaele", "Adélina Gallet", "Flavie Maison", "Maryline Ventura"],
  "Conseil Municipal": ["Pierre Maison", "Pascal Bellanger", "Anne Virtel", "Arnaud Poli", "Claire Vandaele", "Mélanie Darcel", "Gilles Laburthe", "Adélina Gallet", "François Petit", "Awa Kouyate", "Frédéric Gasset", "Denis Boivin", "Flavie Maison", "Quentin Bellanger", "Maryline Ventura", "Yves Malaurent"],
  "Infos communauté de communes": ["Pierre Maison", "Pascal Bellanger", "Anne Virtel", "Arnaud Poli", "Claire Vandaele", "Mélanie Darcel", "Gilles Laburthe", "Adélina Gallet", "François Petit", "Awa Kouyate", "Frédéric Gasset", "Denis Boivin", "Flavie Maison", "Quentin Bellanger", "Maryline Ventura", "Yves Malaurent"],
  "Validation menus": ["Arnaud Poli", "Maryline Ventura", "Denis Boivin", "Mélanie Darcel"],
...
export const MEMBRES_PAR_COMMISSION_ID: Record<string, string[]> = {
  ...
  "24": MEMBRES_COMMISSIONS["Validation menus"],
}
